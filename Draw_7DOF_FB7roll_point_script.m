...
for cnt=1:10:max_cnt
    ...
    %%  ========畫經過IK FK運算後路徑上的點======== %%
    %Right Arm
    plot3(PathIFKPointRec_R.data(1:cnt,1),PathIFKPointRec_R.data(1:cnt,2),PathIFKPointRec_R.data(1:cnt,3),'-b','MarkerSize',2,'Linewidth',2);
    plot3(PathPlanPointRec_R.data(1:cnt,1),PathPlanPointRec_R.data(1:cnt,2),PathPlanPointRec_R.data(1:cnt,3),'--r','MarkerSize',2,'Linewidth',2);
