...
for cnt=1:10:max_cnt
    ...
    %分手臂動作區段畫圖 需要關掉hold off
    
%     if cnt<(3/DEF_CYCLE_TIME)
%         plot3(PathPlanPointRec_R.data(1:cnt,1),PathPlanPointRec_R.data(1:cnt,2),PathPlanPointRec_R.data(1:cnt,3),'b-','MarkerSize',2,'Linewidth',2);
%         plot3(PathPlanPointRec_L.data(1:cnt,1),PathPlanPointRec_L.data(1:cnt,2),PathPlanPointRec_L.data(1:cnt,3),'b-','MarkerSize',2,'Linewidth',2);
%     elseif cnt<(12/DEF_CYCLE_TIME)
%         plot3(PathPlanPointRec_R.data(3/DEF_CYCLE_TIME:cnt,1),PathPlanPointRec_R.data(3/DEF_CYCLE_TIME:cnt,2),PathPlanPointRec_R.data(3/DEF_CYCLE_TIME:cnt,3),'g:','MarkerSize',2,'Linewidth',2); 
%         plot3(PathPlanPointRec_L.data(3/DEF_CYCLE_TIME:cnt,1),PathPlanPointRec_L.data(3/DEF_CYCLE_TIME:cnt,2),PathPlanPointRec_L.data(3/DEF_CYCLE_TIME:cnt,3),'g:.','MarkerSize',2,'Linewidth',2);
%     elseif cnt<(18/DEF_CYCLE_TIME)
%         plot3(PathPlanPointRec_R.data(12/DEF_CYCLE_TIME:cnt,1),PathPlanPointRec_R.data(12/DEF_CYCLE_TIME:cnt,2),PathPlanPointRec_R.data(12/DEF_CYCLE_TIME:cnt,3),'r-.','MarkerSize',2,'Linewidth',2); 
%         plot3(PathPlanPointRec_L.data(12/DEF_CYCLE_TIME:cnt,1),PathPlanPointRec_L.data(12/DEF_CYCLE_TIME:cnt,2),PathPlanPointRec_L.data(12/DEF_CYCLE_TIME:cnt,3),'r-.','MarkerSize',2,'Linewidth',2);
%     else
%         plot3(PathPlanPointRec_R.data(18/DEF_CYCLE_TIME:cnt,1),PathPlanPointRec_R.data(18/DEF_CYCLE_TIME:cnt,2),PathPlanPointRec_R.data(18/DEF_CYCLE_TIME:cnt,3),'c--','MarkerSize',2,'Linewidth',2);
%         plot3(PathPlanPointRec_L.data(18/DEF_CYCLE_TIME:cnt,1),PathPlanPointRec_L.data(18/DEF_CYCLE_TIME:cnt,2),PathPlanPointRec_L.data(18/DEF_CYCLE_TIME:cnt,3),'c--','MarkerSize',2,'Linewidth',2);
%     end
